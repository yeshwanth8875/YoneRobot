...
PM_START_TEXT = """
ʜᴇʟʟᴏ [🤗](https://telegra.ph/file/26e695185dbfe07f134f0.jpg), ɪᴍ LIZZA ᴀ ʜɪɢʜʏ ᴀᴅᴠᴀɴᴄᴇᴅ ʙᴏᴛ ᴡɪᴛʜ ʟᴏᴛꜱ ᴏꜰ ᴀᴍᴀᴢɪɴɢ ᴛᴏᴏʟꜱ.
...
buttons = [
    [
        InlineKeyboardButton(
            text="🕹️ADD ME TO YOUR GROUP🕹️", url="http://t.me/MissLizza_bot?startgroup=true"),
    ],
    [
    ...
    [
        InlineKeyboardButton(
            text="😎DEVOLEPER", url="https://t.me/Cutozki") 
    ],
    [
...
HELP_STRINGS = """
`ʜɪ.. ɪ'ᴍ` [LIZZA](https://telegra.ph/file/f316ddb569d0625c2bf0b.jpg) 
...
def yone_about_callback(update, context):
    ...
    if query.data == "yone_":
        query.message.edit_text(
            text=""" ℹ️ I'm *LIZZA*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n\n_lizza's licensed under the GNU General Public License v3.0_
                 \nHere is the [💾WEBSITE](https://visi.tk/lizza).
                 \n\nIf you have any question about lizza, let us know at .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "Yes, lizza here and am alive.")
        except Unauthorized:
            LOGGER.warning(
